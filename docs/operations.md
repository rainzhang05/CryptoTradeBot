...
- show a simple right-side scrollbar automatically on transcript, forms, and other overflow regions, with thumb colors that remain visible on both light and dark terminal palettes
